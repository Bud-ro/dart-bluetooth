...
/// A scriptable, in-memory [BluetoothClassicPlatform] for tests.
///
...
class FakeBluetoothClassicPlatform extends BluetoothClassicPlatform {
  FakeBluetoothClassicPlatform({
    this.supported = true,
