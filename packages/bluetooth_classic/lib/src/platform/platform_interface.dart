...
/// [BluetoothClassicPlatform.instance] based on the host OS. All methods run
/// their blocking work off the calling isolate so the app never hangs.
abstract class BluetoothClassicPlatform {
  BluetoothClassicPlatform();

  static BluetoothClassicPlatform? _instance;

  /// The active backend. Defaults to the host-appropriate implementation;
  /// tests may override it with a fake.
  static BluetoothClassicPlatform get instance =>
      _instance ??= _defaultInstance();

  static set instance(BluetoothClassicPlatform value) => _instance = value;

  /// Resets to the auto-selected backend (used by tests).
  static void resetInstance() => _instance = null;

  static BluetoothClassicPlatform _defaultInstance() {
